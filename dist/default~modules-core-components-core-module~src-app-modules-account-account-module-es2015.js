...
/* harmony import */ var _profile_profile_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./profile/profile.component */ "./src/app/modules/account/profile/profile.component.ts");
...
AccountModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        exports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"]
        ]
    })
], AccountModule);
...
/* harmony import */ var _core_services_account_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/services/account.service */ "./src/app/modules/core/services/account.service.ts");
...
/* harmony import */ var _core_services_jwttoken_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/services/jwttoken.service */ "./src/app/modules/core/services/jwttoken.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ProfileComponent = class ProfileComponent {
    constructor(accountService, jwtTokenService, authService, formBuilder) {
    ...
    onSubmit() {
        if (this.form.valid) {
            const accountDetail = this.form.value;
...
ProfileComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/account/profile/profile.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./profile.component.css */ "./src/app/modules/account/profile/profile.component.css")).default]
    }),
    __metadata("design:paramtypes", [_core_services_account_service__WEBPACK_IMPORTED_MODULE_2__["AccountService"],
        _core_services_jwttoken_service__WEBPACK_IMPORTED_MODULE_4__["JWTTokenService"],
...
class AccountDetail {
    constructor(id, firstName, lastName, emailAdress) {
        this.id = id;
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _constant_constant__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../constant/constant */ "./src/app/modules/core/constant/constant.ts");
/* harmony import */ var _model_account_detail_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/account-detail.model */ "./src/app/modules/core/model/account-detail.model.ts");
/* harmony import */ var _model_account_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/account.model */ "./src/app/modules/core/model/account.model.ts");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth.service */ "./src/app/modules/core/services/auth.service.ts");
/* harmony import */ var _jwttoken_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./jwttoken.service */ "./src/app/modules/core/services/jwttoken.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AccountService = class AccountService {
    constructor(authService, jwtTokenService, httpClient) {
        this.authService = authService;
        this.jwtTokenService = jwtTokenService;
    ...
    getAccountDetail(userName) {
        let account = new _model_account_model__WEBPACK_IMPORTED_MODULE_4__["Account"](userName, null);
        this.httpClient.get(this.constant.SERVICE_URL + '/manage/myprofile')
            .subscribe(resData => {
            if (resData.code === '200') {
                const role = this.jwtTokenService.getRole();
                const data = resData.data;
                const accountDetail = new _model_account_detail_model__WEBPACK_IMPORTED_MODULE_3__["AccountDetail"](data.id, data.firstName, data.lastName, data.emailAdress);
                this.account = new _model_account_model__WEBPACK_IMPORTED_MODULE_4__["Account"](userName, accountDetail, null, role);
            }
        });
    }
    saveAccountDetail(account) {
        this.httpClient.post(this.constant.SERVICE_URL + '/manage/myprofile', account.accountDetail)
            .subscribe(resData => {
...
AccountService = __decorate([
    ...
    __metadata("design:paramtypes", [_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"],
        _jwttoken_service__WEBPACK_IMPORTED_MODULE_6__["JWTTokenService"],
...
//# sourceMappingURL=default~modules-core-components-core-module~src-app-modules-account-account-module-es2015.js.map