...
/* harmony import */ var _branch_branch_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../branch/branch.module */ "./src/app/modules/branch/branch.module.ts");
/* harmony import */ var _core_enums_Role_enum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/enums/Role.enum */ "./src/app/modules/core/enums/Role.enum.ts");
/* harmony import */ var _company_company_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./company/company.component */ "./src/app/modules/company/company/company.component.ts");
    ...
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild([
                { path: '', component: _company_company_component__WEBPACK_IMPORTED_MODULE_6__["CompanyComponent"], data: { roles: [_core_enums_Role_enum__WEBPACK_IMPORTED_MODULE_5__["Role"].ADMIN] } }
            ]),
...
/* harmony import */ var _core_services_company_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/services/company.service */ "./src/app/modules/core/services/company.service.ts");
/* harmony import */ var _core_services_places_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../core/services/places.service */ "./src/app/modules/core/services/places.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let CompanyComponent = class CompanyComponent {
    constructor(companyService, formBuilder, placesService, branchService) {
...
CompanyComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./company.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/company/company/company.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./company.component.css */ "./src/app/modules/company/company/company.component.css")).default]
    }),
    __metadata("design:paramtypes", [_core_services_company_service__WEBPACK_IMPORTED_MODULE_4__["CompanyService"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
        _core_services_places_service__WEBPACK_IMPORTED_MODULE_5__["PlacesService"],
        _core_services_branch_service__WEBPACK_IMPORTED_MODULE_3__["BranchService"]])
], CompanyComponent);
...
/* harmony import */ var _constant_constant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../constant/constant */ "./src/app/modules/core/constant/constant.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let PlacesService = class PlacesService {
    ...
    getProvinceList() {
        let province = this.localStorageService.getProvinceList();
        if (province) {
            console.log(province);
            this.province.next(province);
        }
        this.httpClient.get(this.constant.SERVICE_URL + '/places/province').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1))
            .subscribe(resData => {
...
PlacesService = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({ providedIn: 'root' }),
    __metadata("design:paramtypes", [_local_storage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]])
], PlacesService);
