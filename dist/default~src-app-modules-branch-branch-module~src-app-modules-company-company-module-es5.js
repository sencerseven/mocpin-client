...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~src-app-modules-branch-branch-module~src-app-modules-company-company-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesBranchBranchItemBranchItemComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesBranchBranchListBranchListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesBranchEditEditComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesBranchBranchItemBranchItemComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesBranchBranchItemBranchItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BranchItemComponent", function () {
    ...
    var _core_services_branch_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var BranchItemComponent =
    /*#__PURE__*/
    function () {
      function BranchItemComponent(branchService) {
        _classCallCheck(this, BranchItemComponent);

        this.branchService = branchService;
      }

      _createClass(BranchItemComponent, [{
        key: "ngOnInit",
    ...
    BranchItemComponent.ctorParameters = function () {
      return [{
        type: _core_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]
      }];
    };

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('branch'), __metadata("design:type", Object)], BranchItemComponent.prototype, "branch", void 0);

    BranchItemComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: '[app-branch-item]',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./branch-item.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/branch/branch-item/branch-item.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./branch-item.component.css */
      "./src/app/modules/branch/branch-item/branch-item.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_core_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]])], BranchItemComponent);
    /***/
  },
  ...
  /***/
  function srcAppModulesBranchBranchListBranchListComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesBranchBranchListBranchListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BranchListComponent", function () {
    ...
    var BranchListComponent =
    /*#__PURE__*/
    function () {
      function BranchListComponent(branchService) {
        _classCallCheck(this, BranchListComponent);

        this.branchService = branchService;
      }

      _createClass(BranchListComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          var branchSubscriber;
          branchSubscriber = this.branchService.companyBranches.subscribe(function (resData) {
            _this.branches = resData;
          });
        }
      }]);
    ...
    BranchListComponent.ctorParameters = function () {
      return [{
        type: _core_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]
      }];
    };

    BranchListComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      selector: 'app-branch-list',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./branch-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/branch/branch-list/branch-list.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./branch-list.component.css */
      "./src/app/modules/branch/branch-list/branch-list.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_core_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]])], BranchListComponent);
    /***/
  },
  ...
  /***/
  function srcAppModulesBranchBranchModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _core_components_maps_maps_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../core/components/maps/maps.component */
    "./src/app/modules/core/components/maps/maps.component.ts");
    /* harmony import */


    var _core_resolver_branch_edit_resolver_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../core/resolver/branch-edit-resolver.service */
    "./src/app/modules/core/resolver/branch-edit-resolver.service.ts");
    /* harmony import */


    var _branch_item_branch_item_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./branch-item/branch-item.component */
    "./src/app/modules/branch/branch-item/branch-item.component.ts");
    /* harmony import */


    var _branch_list_branch_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./branch-list/branch-list.component */
    "./src/app/modules/branch/branch-list/branch-list.component.ts");
    /* harmony import */
    ...
    BranchModule = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_edit_edit_component__WEBPACK_IMPORTED_MODULE_10__["EditComponent"], _core_components_maps_maps_component__WEBPACK_IMPORTED_MODULE_6__["MapsComponent"], _branch_list_branch_list_component__WEBPACK_IMPORTED_MODULE_9__["BranchListComponent"], _branch_item_branch_item_component__WEBPACK_IMPORTED_MODULE_8__["BranchItemComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _agm_core__WEBPACK_IMPORTED_MODULE_0__["AgmCoreModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild([{
        path: 'add',
        component: _edit_edit_component__WEBPACK_IMPORTED_MODULE_10__["EditComponent"]
      }, {
        path: 'edit/:id',
        component: _edit_edit_component__WEBPACK_IMPORTED_MODULE_10__["EditComponent"],
        resolve: [_core_resolver_branch_edit_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BranchEditResolver"]]
      }])],
      exports: [_core_components_maps_maps_component__WEBPACK_IMPORTED_MODULE_6__["MapsComponent"], _branch_list_branch_list_component__WEBPACK_IMPORTED_MODULE_9__["BranchListComponent"]]
    })], BranchModule);
    /***/
  },
  ...
  /***/
  function srcAppModulesBranchEditEditComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppModulesBranchEditEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function EditComponent(route, router, branchService) {
      ...
      _createClass(EditComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.editMode) {
            this.route.data.subscribe(function (resData) {
              _this2.branchOutput = resData[0];

              _this2.formBranch.patchValue({
                name: _this2.branchOutput.name
              });

              _this2.branchInput = {
                id: _this2.branchOutput.id,
                fullAddress: _this2.branchOutput.fullAddress,
                latitude: _this2.branchOutput.latitude,
                longatitue: _this2.branchOutput.longatitue,
                name: _this2.branchOutput.name
              };
              _this2.mapsModel = {
                address: _this2.branchOutput.fullAddress,
                latitude: _this2.branchOutput.latitude,
                longitude: _this2.branchOutput.longatitue
              };
            });
          }
        }
        ...
        key: "setLatitude",
        value: function setLatitude(item) {
          debugger;
        ...
        value: function addBranch() {
          ...
          if (this.formBranch.valid) {
            ...
            this.branchService.updateBranch(this.branchInput).subscribe(function (resData) {
              _this3.router.navigate(['/settings/company']);
            });
          }
        }
      }]);
    ...
    EditComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/branch/edit/edit.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./edit.component.css */
      "./src/app/modules/branch/edit/edit.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _core_services_branch_service__WEBPACK_IMPORTED_MODULE_3__["BranchService"]])], EditComponent);
    /***/
  },
  ...
  /***/
  function srcAppModulesCoreResolverBranchEditResolverServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BranchEditResolver", function () {
      return BranchEditResolver;
    });
    /* harmony import */
    ...
    var BranchEditResolver =
    /*#__PURE__*/
    function () {
      function BranchEditResolver(branchService) {
        _classCallCheck(this, BranchEditResolver);

        this.branchService = branchService;
      }

      _createClass(BranchEditResolver, [{
        key: "resolve",
        value: function resolve(route, state) {
          var _this4 = this;

          return new Promise(function (resolve, reject) {
            return _this4.branchService.getBranch(route.params['id']).subscribe(function (resData) {
              resolve(resData);
            });
          });
        }
    ...
    BranchEditResolver.ctorParameters = function () {
      return [{
        type: _services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]
      }];
    };

    BranchEditResolver = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
      providedIn: 'root'
    }), __metadata("design:paramtypes", [_services_branch_service__WEBPACK_IMPORTED_MODULE_1__["BranchService"]])], BranchEditResolver);
    /***/
  },
      ...
      _createClass(BranchService, [{
        ...
        value: function getAllBranchForList() {
          ...
          return this.httpClient.get(this.constant.SERVICE_URL + "/manage/branch/all").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (resData) {
            _this5.companyBranches.next(resData);
          }));
        }
      }, {
        key: "getBranch",
...
//# sourceMappingURL=default~src-app-modules-branch-branch-module~src-app-modules-company-company-module-es5.js.map