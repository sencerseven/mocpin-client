...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-core-components-core-module~src-app-modules-branch-branch-module~src-app-modules-com~9c33fe46"], {
  /***/
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/core/components/maps/maps.component.html":
  /*!********************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/modules/core/components/maps/maps.component.html ***!
    \********************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppModulesCoreComponentsMapsMapsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "<div class=\"container\">\n\n  <div class=\"form-group\">\n    <label>Adres Giriniz</label>\n    <input type=\"text\" class=\"form-control\" (keydown.enter)=\"$event.preventDefault()\" \n    placeholder=\"Adress/Konum\" [value]=\"address\" autocorrect=\"off\" autocapitalize=\"off\" spellcheck=\"off\" type=\"text\" #search>\n  </div>\n\n  <agm-map [latitude]=\"latitude\" [longitude]=\"longitude\" [zoom]=\"zoom\">\n    <agm-marker [latitude]=\"latitude\" [longitude]=\"longitude\" [markerDraggable]=\"true\"\n      (dragEnd)=\"markerDragEnd($event)\"\n      (animationChange)=\"markerDragEnd($event)\" ></agm-marker>\n  </agm-map>\n\n  <h5>Address: {{address}}</h5>\n  <div>Latitude: {{latitude}}</div>\n  <div>Longitude: {{longitude}}</div>\n</div>";
    /***/
  },

  /***/
  "./src/app/modules/core/components/maps/maps.component.css":
  /*!*****************************************************************!*\
    !*** ./src/app/modules/core/components/maps/maps.component.css ***!
    \*****************************************************************/
  ...
  /***/
  function srcAppModulesCoreComponentsMapsMapsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "agm-map {\r\n  height: 500px;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /*! exports provided: mapsModel, MapsComponent */

  /***/
  function srcAppModulesCoreComponentsMapsMapsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "mapsModel", function () {
      return mapsModel;
    });
    /* harmony export (binding) */
    ...
    var mapsModel = function mapsModel() {
      _classCallCheck(this, mapsModel);
    };
    ...
    function () {
      function MapsComponent(mapsAPILoader, ngZone) {
        ...
        this.ngZone = ngZone;
        this.maps = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
      ...
      _createClass(MapsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.mapsModel = new mapsModel(); //load Places Autocomplete
          ...
          this.mapsAPILoader.load().then(function () {
            ...
            var autocomplete = new google.maps.places.Autocomplete(_this82.searchElementRef.nativeElement);
            autocomplete.addListener("place_changed", function () {
              _this82.ngZone.run(function () {
                //get the place result
                var place = autocomplete.getPlace();
                debugger; //verify result

                if (place.geometry === undefined || place.geometry === null) {
                  return;
                }

                console.log(place.geometry.location.lat()); //set latitude, longitude and zoom

                _this82.latitude = place.geometry.location.lat();
                _this82.longitude = place.geometry.location.lng();
                _this82.zoom = 12;

                _this82.getAddress(_this82.latitude, _this82.longitude);
              });
            });
          });
          ...
          if (!this.inputMaps) {
            if ('geolocation' in navigator) {
              navigator.geolocation.getCurrentPosition(function (position) {
                _this83.latitude = position.coords.latitude;
                _this83.longitude = position.coords.longitude;
                _this83.zoom = 15;

                _this83.getAddress(_this83.latitude, _this83.longitude);
              });
            }
          } else {
        ...
        value: function getAddress(latitude, longitude) {
          ...
          this.geoCoder.geocode({
            ...
            if (status === 'OK') {
              if (results[0]) {
                _this84.address = results[0].formatted_address;
                debugger; //this.mapsModel.address = results[0].formatted_address;

                _this84.mapsModel.address = _this84.address;
                _this84.mapsModel.latitude = latitude;
                _this84.mapsModel.longitude = longitude;

                _this84.maps.emit(_this84.mapsModel);
              } else {
    ...
    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])("maps"), __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"])], MapsComponent.prototype, "maps", void 0);

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])("inputMaps"), __metadata("design:type", Object)], MapsComponent.prototype, "inputMaps", void 0);

    __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('search'), __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], MapsComponent.prototype, "searchElementRef", void 0);

    MapsComponent = __decorate([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-maps',
      template: __importDefault(__webpack_require__(
      /*! raw-loader!./maps.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/core/components/maps/maps.component.html"))["default"],
      styles: [__importDefault(__webpack_require__(
      /*! ./maps.component.css */
      "./src/app/modules/core/components/maps/maps.component.css"))["default"]]
    }), __metadata("design:paramtypes", [_agm_core__WEBPACK_IMPORTED_MODULE_0__["MapsAPILoader"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]])], MapsComponent);
    /***/
  }
}]);
//# sourceMappingURL=default~modules-core-components-core-module~src-app-modules-branch-branch-module~src-app-modules-com~9c33fe46-es5.js.map